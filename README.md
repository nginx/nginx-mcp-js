...
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/nginx/nginx-mcp-js/badge)](https://securityscorecards.dev/viewer/?uri=github.com/nginx/nginx-mcp-js)
